			...
			<tbody>
				<s:iterator value="teachers" status="techerStatus">
					<tr>
						...
						<td><s:url id="editURL" action="edit" namespace="/admin">
								<s:param name="id" value="%{id}" />
							</s:url> <s:a href="%{editURL}">
								<img src="<s:url value="images/edit.png" namespace="/admin"/>" />
							</s:a> <s:url id="deleteURL" action="delete" namespace="/admin">
								<s:param name="id" value="%{id}" />
							</s:url> 
							<s:a href="%{deleteURL}">
								<img src="<s:url value="images/delete.png" namespace="/admin"/>" />
							</s:a></td>
					</tr>
				</s:iterator>
			</tbody>
...
<script language="javascript" type="text/javascript"
	src="<s:url value="js/list.js" namespace="/admin"/>"></script>